...
$settings['config_sync_directory'] = 'sites/default/files/config_HkNvgOf-UU5HLKVMvmwnZEQOXX65bmo8VKSTHjxXM4hE5D31XkNgQEl5GZO3-5X4hdfRmZpOKQ/sync';

$settings['trusted_host_patterns'] = [
  '^localhost$',
  '^127\.0\.0\.1$',
  '^phucnt-chating-app\.training\.weebpal\.com$',
];

# Kich hoat settings.local.php (Them boi Phuc)
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
  include $app_root . '/' . $site_path . '/settings.local.php';
}
