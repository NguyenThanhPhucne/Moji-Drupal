...
const CHECKS = [
  ...
  },
  {
    ...
    alpha: 0.7,
    min: MIN_AA_NORMAL,
    rationale: "Opacity-reduced helper text frequently appears in chips and metadata.",
    fix: "Raise muted text alpha to >= 0.82 or use non-alpha muted token.",
  },
  {
    id: "muted-overlay-60",
    fg: "mutedForeground",
    ...
    alpha: 0.6,
    min: MIN_AA_NORMAL,
    rationale: "Muted/60 is common in small labels and often fails AA.",
    fix: "Avoid /60 for small text; use mutedForeground or larger size with stronger weight.",
  },
  {
    id: "card-body-text",
    fg: "foreground",
  ...
  {
    id: "enterprise-muted-overlay-70",
    fg: "enterpriseMuted",
    bg: "enterprisePanel",
    alpha: 0.7,
    min: MIN_AA_NORMAL,
    rationale: "Opacity-muted enterprise labels appear in multiple route headers.",
    fix: "Increase muted contrast in route headers and empty-state subtitles.",
  },
  {
