...
const PostCardHeader = ({
  ...
  return (
    <header className="social-post-header flex items-start justify-between gap-3" data-testid="post-card-header">
      <button
        type="button"
        className="social-post-author-trigger flex items-center gap-3 text-left group"
      ...
      >
        ...
        <div className="author-avatar-wrap flex-shrink-0">
          <div className="social-avatar-badge social-post-avatar flex h-10 w-10 items-center justify-center overflow-hidden rounded-full text-xs font-semibold ring-2 ring-transparent group-hover:ring-primary/25 transition-colors duration-200">
      ...
      {isOwnPost && canDeletePost ? (
        <button
          type="button"
          className="social-post-option-btn rounded-full p-2 hover:bg-primary/8 hover:text-primary transition-colors duration-150"
        ...
        <button
          type="button"
          className="social-post-option-btn rounded-full p-2 hover:bg-muted/60 transition-colors duration-150"
